        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Orders_TrackingCode", x => x.TrackingCode);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Author = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
                    OrderTrackingCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetailOrders", x => x.id);
                    table.ForeignKey(
                        name: "FK_DetailOrders_Orders_OrderTrackingCode",
                        column: x => x.OrderTrackingCode,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetailOrders_OrderTrackingCode",
                table: "DetailOrders",
